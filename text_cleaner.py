...
class TextCleaner:
    ...
    def calculate_similarity(self, sentence1, sentence2, criteria):
        ...
        Args:
            ...
            criteria (str): 유사도 계산 기준 ("max" 또는 "min")
